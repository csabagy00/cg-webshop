...
namespace cgWebShopApi.Migrations
{
    ...
    [Migration("20240601140137_removedOrdersFromProduct")]
    partial class removedOrdersFromProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cgWebShopApi.Models.OrderedProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("cgWebShopApi.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("cgWebShopApi.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("cgWebShopApi.Models.OrderedProduct", b =>
                {
                    b.HasOne("cgWebShopApi.Models.Order", "Order")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("cgWebShopApi.Models.Product", b =>
                {
                    b.HasOne("cgWebShopApi.Models.Category", "Category")
                        .WithMany("Products")
